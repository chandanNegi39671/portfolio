...
const stats = [
  ...
  { value: "6", label: "Production-grade AI systems shipped" },
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-56 -z-10 select-none overflow-hidden sm:top-48 lg:top-40">
        <p className="text-gradient whitespace-nowrap text-center font-display text-[18vw] font-bold leading-none tracking-tighter opacity-20 sm:text-[19vw]">
          PORTFOLIO
        </p>
      </div>
      ...
      {/* Main hero content — always a grid, different column proportions per breakpoint */}
      <div className="relative mx-auto mt-10 grid w-full max-w-6xl flex-1 grid-cols-[1fr_85px] items-start gap-3 px-5 pb-12 sm:grid-cols-[1fr_140px] sm:items-end sm:gap-6 sm:px-6 sm:pb-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
        {/* Text column */}
        <div className="min-w-0">
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="font-display text-xl italic text-ink-dim sm:text-2xl lg:text-2xl"
          >
            Hello, I'm
          </motion.p>
          ...
          <motion.h1
            ...
            className="font-display text-5xl font-bold uppercase leading-[0.95] tracking-tight text-ink sm:text-6xl lg:text-7xl"
          >
            Chandan
            <br />
            Singh
          ...
          <motion.p
            ...
            className="mt-3 flex min-h-7 items-center font-display text-base font-semibold uppercase tracking-wide text-signal sm:mt-5 sm:text-lg lg:text-xl"
            aria-hidden="true"
          >
            <span className="overflow-hidden text-ellipsis whitespace-nowrap">{roleText}</span>
            <span
          ...
          {/* Description + buttons span full width on all sizes */}
          <motion.p
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.3 }}
            className="mt-5 max-w-md text-sm leading-relaxed text-ink-dim sm:mt-5 sm:text-base"
          >
          ...
          <motion.p
            ...
            className="mt-6 flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-ink-faint sm:mt-8"
          >
        ...
        {/* Photo + stats column — auto width on mobile, 0.95fr on desktop */}
        <div className="flex flex-col items-center gap-4 sm:items-end sm:gap-6 lg:justify-end">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.9, delay: 0.2 }}
            className="relative aspect-[4/5] w-full max-w-full lg:max-w-[360px]"
          >
            <div
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.5 }}
            className="hidden flex-col gap-6 pb-4 sm:flex lg:flex"
          >
            {stats.map((s) => (
